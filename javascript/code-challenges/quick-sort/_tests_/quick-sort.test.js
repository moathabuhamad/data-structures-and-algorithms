...
describe("Quick Sort function", () => {
  it("should sort an unsorted input array", () => {
  ...
  it("should sort a reverse-sorted input array", () => {
    let arr = [20, 18, 12, 8, 5];
    expect(quickSort(arr, 0, 4)).toEqual([5, 8, 12, 18, 20]);
  });

  it("should sort an input array with duplicates", () => {
    let arr = [5, 12, 7, 5, 5, 7, 7];
    expect(quickSort(arr, 0, 6)).toEqual([5, 5, 5, 7, 7, 7, 12]);
  });

  it("should sort an input array that is nearly sorted", () => {
